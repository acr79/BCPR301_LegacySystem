...
edit_sales\n+ edit_bmi\n+ edit_income\n")
            self._showSelectedObjectInfo("Selected Record")
        else:
...
Use the following to set the option:\n+ on\n+ off\n")
            self._showSelectedObjectInfo("Selected Option")
        else:
...
from that\n")
    ...
    def do_on(self, arg):
        ...
        Turn the option on
        """
        theObjectCaller = OptionObjectCaller.ROC_TurnOn()
        self._callSelectedObject(theObjectCaller)
    ...
    def do_off(self, arg):
        ...
        Turn the option off
        """
        theObjectCaller = OptionObjectCaller.ROC_TurnOff()
        self._callSelectedObject(theObjectCaller)
